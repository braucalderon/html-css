...
typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('tiny-lru'), require('@sindresorhus/fnv1a')) :
typeof define === 'function' && define.amd ? define(['tiny-lru', '@sindresorhus/fnv1a'], factory) :
(global = global || self, global.GraphQLHooksMemcache = factory(global.LRU, global.fnv1a));
}(this, (function (LRU, fnv1a) { 'use strict';

LRU = LRU && LRU.hasOwnProperty('default') ? LRU['default'] : LRU;
fnv1a = fnv1a && fnv1a.hasOwnProperty('default') ? fnv1a['default'] : fnv1a;
